...
import (
	...
	"github.com/Hanagasumiiii/ServerKingdomComeTarkov/ent/migrate"
...
func (c *PlayerClient) QueryUser(pl *Player) *UserQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2O, true, player.UserTable, player.UserColumn),
		)
...
// QueryPlayer queries the player edge of a User.
func (c *UserClient) QueryPlayer(u *User) *PlayerQuery {
...
type (
	hooks struct {
		Player, User []ent.Hook
	}
	inters struct {
		Player, User []ent.Interceptor
	}
)
